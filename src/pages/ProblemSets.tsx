    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-2xl md:text-3xl font-bold mb-2">Problem Sets</h1>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    <h2 className="font-semibold text-lg text-foreground">{set.title}</h2>
                    <Badge className={`${difficultyColors[set.difficulty]} border text-xs`}>
                      {set.difficulty}
                    </Badge>
                  </div>
                ...
                <div className="hidden sm:flex items-center gap-3">
                  <div className="text-right">
                    <div className="text-2xl font-bold text-foreground">{set.problemCount}</div>

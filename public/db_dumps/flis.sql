...
--
-- Database: flis
-- Generation Time: 2025-10-05 22:52:39.1070
-- -------------------------------------------------------------
...
DROP TABLE IF EXISTS "public"."match_referees";
-- Table Definition
...
INSERT INTO "public"."teams" ("team_id", "name", "city", "playground", "jersey_home_color", "jersey_away_color") VALUES
...
INSERT INTO "public"."managers" ("mgr_id", "name", "dob", "team_id", "since") VALUES
...
INSERT INTO "public"."matches" ("match_num", "match_date", "host_team_id", "guest_team_id", "host_team_score", "guest_team_score") VALUES
...
INSERT INTO "public"."match_referees" ("match_num", "referee", "assistant_referee_1", "assistant_referee_2", "fourth_referee") VALUES
...
INSERT INTO "public"."referees" ("referee_id", "name", "dob") VALUES
...
INSERT INTO "public"."players" ("player_id", "name", "dob", "jersey_no", "team_id") VALUES
...
-- Indices
CREATE UNIQUE INDEX teams_pk ON public.teams USING btree (team_id);
ALTER TABLE "public"."managers" ADD FOREIGN KEY ("team_id") REFERENCES "public"."teams"("team_id");


-- Indices
CREATE UNIQUE INDEX managers_pk ON public.managers USING btree (mgr_id);
ALTER TABLE "public"."matches" ADD FOREIGN KEY ("host_team_id") REFERENCES "public"."teams"("team_id");
ALTER TABLE "public"."matches" ADD FOREIGN KEY ("guest_team_id") REFERENCES "public"."teams"("team_id");


-- Indices
CREATE UNIQUE INDEX matches_pk ON public.matches USING btree (match_num);
ALTER TABLE "public"."match_referees" ADD FOREIGN KEY ("assistant_referee_1") REFERENCES "public"."referees"("referee_id");
ALTER TABLE "public"."match_referees" ADD FOREIGN KEY ("referee") REFERENCES "public"."referees"("referee_id");
ALTER TABLE "public"."match_referees" ADD FOREIGN KEY ("match_num") REFERENCES "public"."matches"("match_num");
ALTER TABLE "public"."match_referees" ADD FOREIGN KEY ("assistant_referee_2") REFERENCES "public"."referees"("referee_id");
ALTER TABLE "public"."match_referees" ADD FOREIGN KEY ("fourth_referee") REFERENCES "public"."referees"("referee_id");


-- Indices
CREATE UNIQUE INDEX referees_pk ON public.referees USING btree (referee_id);
ALTER TABLE "public"."players" ADD FOREIGN KEY ("team_id") REFERENCES "public"."teams"("team_id");


-- Indices
CREATE UNIQUE INDEX players_pk ON public.players USING btree (player_id);
